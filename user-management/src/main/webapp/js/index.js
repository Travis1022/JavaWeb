...
function addTab(subtitle,menuid,icon){
	if(!$('#tabs').tabs('exists',subtitle)){
		$('#tabs').tabs('add',{
			title:subtitle,
			content:createFrame(menuid),
			closable:true,
			icon:icon
		});
	}else{
...
{
	var s = '<iframe scrolling="auto" frameborder="0"  src="'+Matt.context+src+'" style="width:100%;height:100%;"></iframe>';
	return s;
}
