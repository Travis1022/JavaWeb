...
Validator = {Require : /.+/,
	...
	//add by lili
	EN: /^[A-Za-z0-9]+$/,
	Numbercannull1 : function(str){
		if(str!=""){
		return this.Number.test(str);
		}
		return true;
	},
	Engornum1:function(str){
	if(str!=""){
		return this.EN.test(str);
		}
		return true;
	},
	IsSafe : function(str) {
	...
	Englishornumnull:"this.Engornum1(value)",
	Numbercannull:"this.Numbercannull1(value)",
		...
		if (this.ErrorMessage.length > 1) {
			...
			case 4:
				...
				for ( var i = 1; i < errCount; i++) {
					try {
						if(tempParentNode!=this.ErrorItem[i].parentNode && tempParentNode!="undefined"){
						...
						tempParentNode=this.ErrorItem[i].parentNode;
					} catch (e) {
						alert(e.description);
					}
				}
