...
<%@ page import="org.matt.util.Uploader"%>
...
<%
	...
	/*
	String currentPath = request.getRequestURI().replace( request.getServletContext().getRealPath("ueditor"), "" );
	...
	*/
	...
	up.upload();
	response.getWriter().print("{'original':'" + up.getOriginalName() + "','url':'" + up.getUrl()
